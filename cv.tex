...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\huen{Egy olyan programot fejlesztek, aminek az célja, hogy megjósolja a Siemens-es tesztfutások hibaokát -- különböző fajta naplófájlok alapján.}{TODO}\\
		\divider\\	
		\huen{Foglalkoztam műanyag kupakok automatikus kategorizálásával \href{https://new.siemens.com/global/en/products/automation/systems/industrial/plc/simatic-s7-1500/simatic-s7-1500-tm-npu.html}{\underline{NPU}} segítségével. (Egy neurális háló dolgozta fel a futószalagról készült képeket.)}{TODO}\\
		\divider\\		
		\huen{Megvizsgáltam további optimalizációs feladatok megvalósíthatóságát.}{TODO}\\	
		\divider
		\cvevent{\huen{Junior szoftvermérnök}{Junior Software Engineer}}{Evosoft Hungary Kft. (\huen{tesztelési osztály}{Department of Testing})}{\huen{2021. 02. 15. -- 2021. 12. 01.}{15 Feb 2021 -- 01 Dec 2021}}{Infopark}
		\huen{Résztvettem egy olyan dashboard fejlesztésében, ami megkönnyítette a Siemens-es eszközök tesztelését.}{TODO}\\		
		\huen{A legfontosabb feladatom a backend tesztelése és a válaszidő csökkentése volt, de ezenkívül a frontend-del is foglalkoztam.}{TODO}\\
		\divider\\
		\huen{Elkezdtem kidolgozni egy rendszert a Siemens-es naplófájlok kategóriájának automatikus predikciójára.}{arg2}\\
		\huen{ A terv célja a terméktesztelők munkájának segítése volt. A probléma nehézsége a naplófájlok számában, méretében és változatosságában rejlett.}{arg2}\\		
		\divider		
		\medskip		
	...
	\begin{paracol}{1}
		...
		\begin{itemize}[leftmargin=.25in]
			\item \huen{ISTQB Certified Tester Foundation Level vizsgafelkészítő}{TODO} (2021) \hfill {\small \href{https://github.com/tasigabi97/cv/blob/main/istqb_certificate.pdf}{\faFileImage(\huen{tanusítvány}{certificate})}}
			\item \huen{Kubernetes alapozó}{TODO} (2021) \hfill {\small \href{https://github.com/tasigabi97/cv/blob/main/kubernetes_certificate.png}{\faFileImage(\huen{tanusítvány}{certificate})}}
